            ...
            <div class="col-lg-5 col-12 footer-map d-flex flex-column">
                <div class="row ">
                    <div class="p-1 col-lg-6 col-sm-6 location-map">
                        <b>@lang('footer.footer_location_1') <button href="javascript:;" class="hidden-btn-parent" onclick="myFunction1()">@lang('footer.footer_location_btn')<input class="hidden-btn" type="text" value="https://g.page/thewoodcourt?share" id="iframe1"></button></b>
