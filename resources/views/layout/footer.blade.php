<footer class="footer">
  <div class="container-fluid dark-overlap">
    <div class="row">
      ...
      <div class="col-lg-2 col-12 d-flex footer-links">
        <ul>
      ...
      <div class="col-lg-6 col-12 footer-map d-flex justify-content-center align-items-stretch text-center">
          <div class="mr-2 d-flex flex-column justify-content-center align-items-center">
              ...
              <div class="">
                  <p>Cach Payment Merhods</p>
                  <img class="w-25" src="{{url('public/images')}}/payment-images/belcach.png" alt="">
                  <img  src="{{url('public/images')}}/payment-images/visa.png" alt="">
              </div>
          </div>
          <div class="mr-2 d-flex flex-column justify-content-center align-items-center">
              ...
              <div class="">
                  <p>InStore Payment Merhods</p>
                  <img class="w-25" src="{{url('public/images')}}/payment-images/qnb-logo.png" alt="">
                  <img  src="{{url('public/images')}}/payment-images/visa.png" alt="">
              </div>
          </div>
