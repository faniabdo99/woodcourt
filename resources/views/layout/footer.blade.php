    ...
    <div class="container-fluid dark-overlap">
        <div class="row">
            <div class="col-lg-3 col-12 footer-info">
                ...
                <p>The Wood Court is servicing and supplying a vastly growing number of projects for business and
                    private residences in Egypt since 1979. We provide quality work, and help you achieve the most
                    effective improvement you can make for your home or business with reasonable and affordable prices.
                </p>
                <ul>
            ...
            <div class="col-lg-4 col-12 d-flex footer-links">
                <ul>
                    ...
                    <li><a href="{{ route('paymentMethods') }}"><i class="fas fa-credit-card"></i> Payment Methods</a>
                    </li>
                </ul>
                <ul>
            ...
            <div class="col-lg-5 col-12 footer-map d-flex flex-column">
                <div class="d-flex">
                    <div class="p-1">
                        <b>Showroom <button class="hidden-btn-parent" onclick="myFunction1()">Copy Link<input class="hidden-btn" type="text" value="https://g.page/thewoodcourt?share" id="iframe1">
                        </button>
                            </b>
                    ...
                    <div class="p-1">
                        <b>Factory <button class="hidden-btn-parent" onclick="myFunction2()">Copy Link <input class="hidden-btn" type="text" value="https://goo.gl/maps/3VvUAo7KPgCHz9r79" id="iframe2">
                        </button>
                        </b>
                        <iframe class="w-100"
                ...
                <div class="mt-3">
                    ...
                    <div class="footer-payment-methods">
                        ...
                        <p class="mb-0">*Credit cards, checks & Bank transfers are acceptable</p>
                    </div>
                </div>
            </div>
        </div>
