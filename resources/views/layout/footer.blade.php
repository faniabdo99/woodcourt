...
<div class="container-fluid dark-overlap">
    ...
    <div class="col-lg-3 offset-1 col-12 d-flex footer-links">
        <ul>
    ...
    <div class="col-lg-5 col-12 footer-map d-flex flex-column">
                <div class="d-flex">
                    <iframe class="w-100 mr-2 " src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3453.7004975044897!2d31.196790115115157!3d30.045449181881974!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1458413486462911%3A0x945b12fc41fd6e8a!2sThe%20Wood%20Court!5e0!3m2!1sen!2seg!4v1605110935180!5m2!1sen!2seg" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                ...
                <div class="d-flex flex-column w-100 bg-light p-3 brand justify-content-center align-items-center">
                    <h5>Payment Methods</h5>
                    <div>
                        <img src="{{url('public/images/payment-images/qnb-1.png')}}" alt="">
                        <img src="{{url('public/images/payment-images/credit-card.png')}}" alt="">
                        <img src="{{url('public/images/payment-images/check.png')}}" alt="">
                    </div>
    </div>
</div>
</div>
