        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7 col-12">
                    ...
                    <p>كل الأرضيات الخشبية الطبيعية وألواحHDF لتي ستحتاجها في مكان واحد. تصاميم كلاسيكية وحديثة وطبيعية
                        وعتيقة ومعاصرة وحتى مخصصة.</p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-7 col-12">
                    <h2>منتجات داخلية (Indoors)</h2>
                    <p>مع الظروف الاستثنائية الحالية، أدركنا جميعاً أهمية وقيمة مساحاتنا
                    ...
                    <form class="woodcourt-form">
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-12">
                                ...
                                <input type="email" placeholder="يرجى ادخال بريدك الالكتروني هنا" name="email"
                                    id="email" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                ...
                                <button class="icon-button d-lg-inline d-block text-center w-100"
                                    data-target="{{ route('contact.post') }}" id="submit-contact-form"
                                    type="submit"><i class="fas fa-paper-plane"></i> ارسال</button>
                            </div>
                        </div>
                    </form>
                </div>
