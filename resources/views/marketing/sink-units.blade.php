@include('layout.header', ['PageTitle' => 'Sink Units'])
                        ...
                        <ul class="filter-items">
                            ...
                            <li>
                                ...
                                <ul class="filter-sub-items">
                                    ...
                                    <li><a data-target="bathroom-cabinets"  class="active" href="javascript:;">Sink Units</a></li>
                                </ul>
                            </li>
                            <li>
                ...
                <div class="col-lg-9 col-12">
                    <div class="row">
                        <div class="col-12" id="images-list">
                            ...
                            <ul class="category-images-list active cabinets" id="bathroom-cabinets">
