@include('layout.header', ['PageTitle' => 'Dressing'])
                        ...
                        <ul class="filter-items">
                            ...
                            <li>
                                ...
                                <ul class="filter-sub-items">
                                    ...
                                    <li><a data-target="dressings" class="active" href="javascript:;">Dressings</a></li>
                ...
                <div class="col-lg-9 col-12">
                    <div class="row">
                        <div class="col-12" id="images-list">
                            ...
                            <ul class="category-images-list active cabinets" id="dressings">
