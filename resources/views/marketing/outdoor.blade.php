@include('layout.header', ['PageTitle' => 'Outdoor'])
                ...
                <div class="col-lg-3 col-12">
                    <div class="products-sidebar mb-5">
                        ...
                        <ul class="filter-items">
                            ...
                            <li>
                                <a class="main-category-filter active " href="javascript:;" data-target="outdoor">Outdoor</a>
                                <ul class="filter-sub-items">
                ...
                <div class="col-lg-9 col-12">
                    <div class="row">
                        <div class="col-12" id="images-list">
                            ...
                            <ul class="category-images-list active outdoor" id="teak-flooring">
                            ...
                            <ul class="category-images-list active outdoor" id="shower-units">
                            ...
                            <ul class="category-images-list active outdoor" id="pergolas">
