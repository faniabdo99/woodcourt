        ...
        <div class="row">
            <div class="col-lg-4 col-12 ">
                <div class="products-sidebar mb-5" id="expert-hub-sidebar">
                    <ul class="filter-items nav nav-tabs" id="nav-tab" role="tablist">
                        <li>
                            <a class="nav-item nav-link main-category-filter active" data-toggle="tab" href="#FAQs"
                                aria-controls="FAQs">FAQs</a>
                        ...
                        <li>
                            <a class="nav-item nav-link main-category-filter" data-toggle="tab" href="#nav-woodcare"
                                aria-controls="nav-woodcare">Wood Care</a>
                            <ul>
                                <li class="sub-category-filter"><a href="#indoor-flooring">How to Take Care Of Your
                                        Indoor Flooring</a></li>
                                <li class="sub-category-filter"><a href="#woodcare-kitchen">How to Take Care Of Your
                                        Kitchens & Cabinets</a></li>
                                <li class="sub-category-filter"><a href="#outdoor-woodcare">How to Take Care Of Your
                                        Outdoor Floors & Pergolas</a> </li>
                            </ul>
                        </li>
                        <li>
                            <a class="nav-item nav-link main-category-filter" data-toggle="tab"
                                href="#nav-engineered-floors" aria-controls="nav-engineered-floors">Engineered HardWood
                                Flooring</a></li>
                        <li>
                            <a class="nav-item nav-link main-category-filter" data-toggle="tab"
                                href="#nav-installation-methodology"
                                aria-controls="nav-installation-methodology">Installation Methodology</a>
                        </li>
                        <li>
                            <a class="nav-item nav-link main-category-filter" data-toggle="tab"
                        ...
                        <li>
                            <a class="nav-item nav-link main-category-filter" data-toggle="tab" href="#nav-articles"
                                aria-controls="nav-articles">Articles</a>
                            <ul>
            ...
            <div class="col-lg-8">
                <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="collapse-17" class="collapse " aria-labelledby="heading-FAQ-16"
                                        data-parent="#accordionExample">
                                        <p>Laminate flooring is an excellent choice when the look and feel of real wood
                                            is
                    ...
                    <div class="tab-pane fade" id="nav-woodcare" role="tabpanel" aria-labelledby="nav-woodcare">
                        ...
                        <div class="row mt-5 mb-3" id="wood-care">
                            ...
                            <p>In home and office interior designs, the value of wood cannot be denied its timeless
                                visual appeal and natural beauty. If you take proper care of wood floorings, cabinets,
                                installments, and claddings, you can expect them to survive for decades. Let's take a
                    ...
                    <div class="tab-pane fade" id="nav-engineered-floors" role="tabpanel"
                        ...
                        <div class="row mt-5 mb-3" id="engineered-hardwood">
                            ...
                            <p>you can ask for a refinished engineered flooring in which coating are by the menutaclured
                                ...
                                &
                                make it anti-scratch , more durable , and smoother as whrobe operation is done inside
                                a(uv)
                                coating live not exposed to there are no dust sticky to the sarlace and decreame
                                smoother .
                                <br> <br>
                                ...
                                before applying the bottom and top layers , so it is guaranteed that under bad wrage ,
                                the
                    ...
                    <div class="tab-pane fade" id="nav-installation-methodology" role="tabpanel"
                        aria-labelledby="nav-installation-methodology">
                        <div class="row mt-5 " id="installation-methods">
                            ...
                            <ol>
                                <li>
                                    ...
                                    <p>most common & traditional way to install wood floors wood tiles or planks are to
                                        be
                                ...
                                <li>
                                    ...
                                    <p>bonding the wood floors with the subfloors wring quedown tea is a very good and
                                        cheap
                                        way to install your wood floors or D3 water beas glue wring Polyurethane (ol
                                        based)
                                        D4 glue is the best way to ensure lifelong band , as the glue can dissipates
                                        shear
                                        stream restaurant because at the different expand coaticient between the wood &
                                        the
                                        concrete tiles or ceramic tiles ,no drum-noise is heard out all .you will get
                                        lifetime guarantee against debonding from when purchasing from the wood court
                                    </p>
                                </li>
                                <li>
                                    <h4>Floating installation technique</h4>
                                    <p>installing your floors using this technique make it very easy to maintain as you
                                        can
                                        replace any damaged piece early , the wood floors are flooded over the subfloor
                                        ,
                                        royale the lem sheet with 2mm thickness is placed between wood & subfloor to
                                        isolate
                                        moisture and deareane sowels when walking on , this technique also makes it very
                                        easy to uninstall your wood floor and use it again in another place , leaving
                                        the
                            ...
                            <ol>
                                ...
                                <li>
                                    ...
                                    <p>In this type of subfloor , wooden beams made of red pine wood with 5cm square
                                        section
                                        or 5cm by 4cm rectangular section are installed with 25 to 35 pieces of concrete
                                        to
                                        leave the floor , fixed with metal fixtures and concrete to be bended with the
                                        floor. then 1.6cm by 10cm section of some wood type owe installed with about
                                        2-10 cm
                                        spaces in opposite direction to be a top subfloor laid in which wood floor
                                        fixation
                                        takes place . <br>this is the traditional sub flooring used for more than loo
                                        years
                                ...
                                <li>
                                    ...
                                    <p>in this type , we use concrete tiles , mosaic tiles , low quality ceramic tiles
                                        ...
                                        concrete , are fixed on it , this method also is used for nailed down
                                        installation
                                        technique </p>
                                </li>
                                <li>
                                    <h4> Concrete-based tiles subfloor</h4>
                                    <p>used always for glue down & floating installation technique , mosaic or ceramic
                                        tiles
                                        are installed directly using concrete , for leaving them wood floors are glued
                                        down
                                        on it floated on it using polythene sheets to prevent humidity , temperature ,
                                        sound
                                        .</p>
                                </li>
                                <hr>
                    ...
                    <div class="tab-pane fade" id="nav-finishing-techniques" role="tabpanel"
                        aria-labelledby="nav-finishing-techniques">
                        <div class="row mt-5 " id="finishing-techniques">
                            <p>When it comes to choosing hardwood floors, & the question is not only solid or engineered
                                wood Flooring, but also , site- Finish or pre finished Flools? .
                                which one is better? and why ?
                                well, each type has its benefits
                            </p>
                            <h3>1.Site Finish:</h3>
                            <p>When you go for site- Finish wood floors, then you are purchasing wood floors which will
                                be shipped to your home unfinished , to be Sanded, possibly stained and then sealed and
                                finished with a top protective layer in your home.
                                This process takes & a bit a long time, produces dust during sanding , bad smell during
                                coating.
                                in this type
                            </p>
                            <ul>
                            ...
                            <p>Traditionally, you choose sile-finishing when time isn't critical new construction and
                                nobody lives in site (to avoid dust) it Takes long time . (4-6) days to send and clean
                                wood floors , ensure the site is clean , environment is stable within site , applying
                            ...
                            <p>
                                When you get site-finished floors you get seamless to however , with weather savings,
                                graying from high temp , humidity, to low & vice versa , this option fade away , as wood
                                is a living product , it expands and contracts leading to visible joints
                            </p>
                            <h2>2. Pre-Finished:</h2>
                            <p>In the last 25 years, prefinished Floors started to grow, as harduratth Floors
                                manufacturing become more technical in this <br>
                            ...
                            <ul>
                                <li>surface is more durable and anti-scratch due to aluminium oxide and diamond finish
                                </li>
                                <li>installation is faster & easier dusten. You can walk in and put Furniture
                                    immediately.</li>
                            </ul>
                            <h4>Durability :</h4>
                            <p> when the floor manufacturer Finished the floor, it uses special Finished lines, which
                                create <br>
                                Perfect environment to apply powerful chemical scalier such as alumerian & tilenum
                                oxides embedded in a uv-cured urethane Coat <br>
                                the perfect <br>
                                ...
                                however, you can easily replace damaged pieces, or refinish with sanding & Coating as if
                                you have installed site finish Floors.
                            </p>
                            <h4>pre-Finished Floors have beveled edges not square ones not like sile-Finish which can
                                have either square edge or beveled ones</h4>
                            ...
                            <p>it is the process in which the coat a changes from liquid state to solid state under
                                ...
                                <b> Finishing Live, no no dust will stick to planks, so it results with smooth Surface
                                    unlike site finish which it is very hard to prevent very fine dust from sticking to
                                    floors
