                    ...
                    <div class="tab-pane fade show active" id="toturial" role="tabpanel">
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="wood-care" role="tabpanel">
                                ...
                                <img class="mb-4 w-100"
                                    src="https://thewoodcourt.com/storage/app/images/events/how-to-take-care-of-your-wood-floors.png"
                                    alt="1">
                                ...
                                <img class="mb-2 w-100"
                                    ...
                                    alt="1">
                                <p class="mb-4">Do Not use alcohol, acids ,or chemicals to clean your wood floors. It
                                    can damage your wood flooring.</p>
                                <br>
                                ...
                                <img class="mb-2 w-100"
                                    ...
                                    alt="1">
                                <p class="mb-4">Always wipe parallel to grams direction, as that will clean the grooves
                                    much better. Use a microfiber towel to clean your wood floors. It will remove
                                    stains, clean your floor & make it shiny.</p>
                                ...
                                <img class="mb-2 w-100"
                                    ...
                                    alt="1">
                                <p class="mb-4">Remove spills immediately, long exposure to liquids will lead to damage.
                                </p>
                                ...
                                <img class="mb-2 w-100"
                                    ...
                                    alt="1">
                                <p>Don't put any electronics directly on the wood floor ,the heat generated from these
                                    devices will affect your floors negatively in the long run.</p>
                                ...
                                <img class="mb-2 w-100"
                                    ...
                                    alt="1">
                                <p>Don't use the same cleaner for natural wood floors & HDF, each type has its cleaning
                                    liquid.</p>
                                ...
                                <div class="mt-5">
                                    ...
                                    <img class="mb-2 w-100" src="{{url('public/images/wood-care/kitchens/1.png')}}"
                                        alt="1">
                                    <h5>1. Do Remove Food Spills Immediately</h5>
                                    <img class="mb-2 w-100" src="{{url('public/images/wood-care/kitchens/2.png')}}"
                                        alt="1">
                                    ...
                                    <img class="mb-2 w-100" src="{{url('public/images/wood-care/kitchens/3.png')}}"
                                        alt="1">
                                    <p>Prevent spilling of acidic food or juices as much as you can on wood surfaces,
                                        such as orange juice .</p>
                                    <h5>3. Do Use Coasters Under Drinks</h5>
                                    <img class="mb-2 w-100" src="{{url('public/images/wood-care/kitchens/4.png')}}"
                                        alt="1">
                                    <p>Tea, coffee & other many drinks are great, but will leave a bad-look stain on
                                        wood surfaces if they’re not cleaned immediately. </p>
                                    <h5>4. Don’t Clean With a Sponge</h5>
                                    <img class="mb-2 w-100" src="{{url('public/images/wood-care/kitchens/5.png')}}"
                                        alt="1">
                                    <p>When cleaning a wood surface, use a microfiber towel, do not use dish sponge or
                                        washing as it may damage wood surfaces. </p>
                                    <h5>5. Do Wipe With Water and Soap</h5>
                                    <img class="mb-2 w-100" src="{{url('public/images/wood-care/kitchens/6.png')}}"
                                        alt="1">
                                    <p>Clean your kitchen cabinets and surface wring clean water & mild soap with a
                                        clean ,lint-free rag.</p>
                                    <h5>6. Don’t Use Too Much Water</h5>
                                    <img class="mb-2 w-100" src="{{url('public/images/wood-care/kitchens/7.png')}}"
                                        alt="1">
                                    ...
                                    <img class="mb-2 w-100" src="{{url('public/images/wood-care/kitchens/8.png')}}"
                                        alt="1">
                                    <p>Wipe Parallel to the wood grains direction , remove dust with dry micor-fiber
                                        towel , it is your first step to clean your kitchen </p>
                                    <h5>8. Don’t Use Wax to Polish</h5>
                                    <img class="mb-2 w-100" src="{{url('public/images/wood-care/kitchens/9.png')}}"
                                        alt="1">
                                    <p>Always use polish cream monthly to shine your kitchen instead of waxing , wax
                                        makes a shiny look but attracts dust.</p>
                                    <h5>9. Don’t Overuse Silicon Cleaners</h5>
                                    <img class="mb-2 w-100" src="{{url('public/images/wood-care/kitchens/10.png')}}"
                                        alt="1">
                                    ...
                                    <img class="mb-2 w-100" src="{{url('public/images/wood-care/kitchens/11.png')}}"
                                        alt="1">
                                    <p>When it comes to wooden counter-top , it is very important to use a “Food grade
                                        mineral Oil”.</p>
                                    <h5>11. Do Use a Ventilating Fan</h5>
                                    <img class="mb-2 w-100" src="{{url('public/images/wood-care/kitchens/12.png')}}"
                                        alt="1">
                                ...
                                <div class="mt-5">
                                    ...
                                    <p>Use a vacuum machine to remove dust from the in between grooves, it is much
                                        easier than whisking.</p>
                                    <h4>3. Do Use Ammonia to Remove Dirt</h4>
                                    <img class="mb-2 w-100" src="{{url('public')}}/images/wood-care/2.png" alt="1">
                                    <p>Use a mixture of ammonia & warm water with ratio 1:4 to help you remove all the
                                    ...
                                    <p>Use a floor cleaner specially made for your hardwood, It will always be on
                                        oil-based cleaner, not water or aqua-based.</p>
                                    ...
                                    <p>When wood is exposed to direct sunlight, this oil gradually by time will
                                    ...
                                    <p>When applying teak oil, follow the wood grains using a clean rag, and rub in
                                        well.</p>
                                    <h4>4. Don't Use Too Much Oil</h4>
                                    <img class="mb-2 w-100" src="{{url('public')}}/images/wood-care/7.png" alt="1">
                                    <p>Do not apply a heavy layer of oil, 70-100 grams is more than enough for each
                                        square meter.</p>
                                    ...
                                    <p>Always remove any spills immediately, to avoid spots. If you have spots, just
                                        apply a small amount of ammonia and it will disappear instantly.</p>
                                    ...
                                    <p>You don't have to use any insect repellant for teak wood, as teak wood grains are
                                        ...
                                        exposed to extreme conditions.</p>
