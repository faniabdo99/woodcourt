...
<body>
    ...
    <section class="container mt-5 mb-5" id="content-section">
      <div class="row">
        <div class="col-lg-4 col-12">
          <div class="products-sidebar mb-5" id="expert-hub-sidebar">
              <ul class="filter-items nav nav-tabs" id="nav-tab" role="tablist">
                  <li>
                      <a class="nav-item nav-link active main-category-filter" data-toggle="tab" href="#toturial">Tutorials</a>
                ...
                <li>
                  ...
                  <ul class="nav nav-tabs ml-5">
                    <li><a class="nav-item nav-link sub-category-filter active" data-toggle="tab" href="#blog">Blog</a></li>
                    <li><a class="nav-item nav-link sub-category-filter" data-toggle="tab" href="#latest-trends">Latest Trends in Hardwood Flooring</a></li>
                  </ul>
                </li>
              </ul>
          </div>
        ...
        <div class="col-lg-8 col-12">
          <div class="tab-content">
            <div class="tab-pane fade show active" id="toturial" role="tabpanel">
              <div class="tab-content">
                  <div class="tab-pane fade show active" id="wood-care" role="tabpanel">
                    <h2>Wood Care</h2>
                    ...
                    <img class="mb-3 w-100" src="http://thewoodcourt.com/storage/app/public/uploads/ltYOrtTKV30wzAOc30SEEcNOvTRv1KQHY5kbB2Ot.png" alt="1">
                    ...
                    <img class="mb-3 w-100" src="http://thewoodcourt.com/storage/app/public/uploads/uzYjHMQ5Tt6zyTqJHQqVR9JBzasgGw2eri7PL44n.png" alt="1">
                    ...
                    <img class="mb-2 w-100" src="http://thewoodcourt.com/storage/app/public/uploads/Sj1vFB4I46KpAB5VlX9UEZHYsfp4MfaY0XUjVT1V.png" alt="1">
                    ...
                    <img class="mb-2 w-100" src="http://thewoodcourt.com/storage/app/public/uploads/xik2fLJjV9m32ipQFLwzvnGN2gd0pKHURPVR55hO.png" alt="1">
                    ...
                    <img class="mb-2 w-100" src="http://thewoodcourt.com/storage/app/public/uploads/zQ8AuYXmmmgKTIfm0PatB5JvFigvRXt0rBJV3ifA.png" alt="1">
                    ...
                    <img class="mb-2 w-100" src="http://thewoodcourt.com/storage/app/public/uploads/2lUhApr6VCLOLaLGB3cFWTjfwnKZT3tjWWbLK6Js.png" alt="1">
                    ...
                    <img class="mb-2 w-100" src="http://thewoodcourt.com/storage/app/public/uploads/XISP3gHkBrvIlRTcEIMBqP1dkqN526xOrO7NhiJ9.png" alt="1">
                    ...
                    <img class="mb-2 w-100" src="http://thewoodcourt.com/storage/app/public/uploads/onw5BJu5gAGuyOpep23IdyyOVhq6MmIN7uSpmPww.png" alt="1">
                    <p class="mb-4">Use soft coasters under your furniture to prevent scratches.</p>
                    <h4>9. Keep Your Pets' Nails Trimmed </h4>
                    <img class="mb-2 w-100" src="http://thewoodcourt.com/storage/app/public/uploads/vroEA7WRzvrErOlEpIYSXjTEXdpHT3iY74LJcZXN.png" alt="1">
                    <p class="mb-4">Regulary clip your pets’ nails to avoid deep scratches.</p>
                    <h4>10. Don't Expose to Too Much Sunlight</h4>
                    <img class="mb-2 w-100" src="http://thewoodcourt.com/storage/app/public/uploads/fejAVSLONykgFEG7MdAXeOP0Vv1pdVVYjWkyqKgs.png" alt="1">
                    ...
                    <img class="mb-2 w-100" src="http://thewoodcourt.com/storage/app/public/uploads/bpqC8LR9v0fjFkVP7zGwINIYhsCoAfzfbaUK8Bwj.png" alt="1">
                    ...
                    <img class="mb-2 w-100" src="http://thewoodcourt.com/storage/app/public/uploads/AtnAVyfVg1LTVoiQcyjII8G7sLm0I2pC1cx9Bfd2.png" alt="1">
                    ...
                    <img class="mb-2 w-100" src="http://thewoodcourt.com/storage/app/public/uploads/Br5oXoWSbrVSk1zK3IXWg96mZUpLWWYeiJkyvFb6.png" alt="1">
                    ...
                    <img class="mb-2 w-100" src="http://thewoodcourt.com/storage/app/public/uploads/FnoywSowXzTiNnXp40BWtAf0ZemtsU6Cnx4mVgJX.png" alt="1">
                    ...
                    <div class="mt-5">
                        ...
                        <h5>2. Do Prevent Spilling Acidic Juices</h5>
                        <img class="mb-2 w-100" src="{{url('public/images/wood-care/kitchens/3.png')}}" alt="1">
                        <p>Prevent spilling of acidic food or juices as much as you can on wood surfaces, such as orange juice .</p>
                        <h5>3. Do Use Coasters Under Drinks</h5>
                        <img class="mb-2 w-100" src="{{url('public/images/wood-care/kitchens/4.png')}}" alt="1">
                        <p>Tea, coffee & other many drinks are great, but will leave a bad-look stain on wood surfaces if they’re not cleaned immediately. </p>
                        <h5>4. Don’t Clean With a Sponge</h5>
                        <img class="mb-2 w-100" src="{{url('public/images/wood-care/kitchens/5.png')}}" alt="1">
                        <p>When cleaning a wood surface, use a microfiber towel, do not use dish sponge or washing as it may damage wood surfaces. </p>
                        <h5>5. Do Wipe With Water and Soap</h5>
                        <img class="mb-2 w-100" src="{{url('public/images/wood-care/kitchens/6.png')}}" alt="1">
                        <p>Clean your kitchen cabinets and surface wring clean water & mild soap with a clean ,lint-free rag.</p>
                        <h5>6. Don’t Use Too Much Water</h5>
                        <img class="mb-2 w-100" src="{{url('public/images/wood-care/kitchens/7.png')}}" alt="1">
                        <p>Use water sparingly and a towel to dry any excess , when water sits , it can penetrate the finish and raise the wood grains up leading to a rough uncleanable surface in future.</p>
                        <h5>7. Do Wipe Parallel to The Grain</h5>
                        <img class="mb-2 w-100" src="{{url('public/images/wood-care/kitchens/8.png')}}" alt="1">
                        <p>Wipe Parallel to the wood grains direction , remove dust with dry micor-fiber towel , it is your first step to clean your kitchen </p>
                        <h5>8. Don’t Use Wax to Polish</h5>
                        <img class="mb-2 w-100" src="{{url('public/images/wood-care/kitchens/9.png')}}" alt="1">
                        <p>Always use polish cream monthly to shine your kitchen instead of waxing , wax makes a shiny look but attracts dust.</p>
                        <h5>9. Don’t Overuse Silicon Cleaners</h5>
                        <img class="mb-2 w-100" src="{{url('public/images/wood-care/kitchens/10.png')}}" alt="1">
                        <p>Be cautious of overuse of surface cleaners & sprays as they may contain silicon, which will make layers & layers order wood surface & results with a pale look with time.</p>
                        <h5>10. Do Use Food-grade Mineral Oil</h5>
                        <img class="mb-2 w-100" src="{{url('public/images/wood-care/kitchens/11.png')}}" alt="1">
                        <p>When it comes to wooden counter-top , it is very important to use a “Food grade mineral Oil”.</p>
                        <h5>11. Do Use a Ventilating Fan</h5>
                        <img class="mb-2 w-100" src="{{url('public/images/wood-care/kitchens/12.png')}}" alt="1">
                        <p>Use a ventilating fan when cooking , it remove the majority of airborne smoke & grease which other wish may be absorbed by wood leading to bad smell & yellowish stains</p>
                    </div>
                    <div class="mt-5">
                        <h3>How to Take Care of wooden pergolas & Outdoor Flooring ?</h3>
                        <p class="mt-3">Wood is a beautiful option for your garden Flooring, under pergola , and outdoor area of your restaurant or cafe , also the wooden pergola itself gives your home privacy & make you have a great time outdoors, the wood grains and variety of colors when beside the wonderful green color of plants . <br> teak wood especially its very durable and has high resistance to outdoor conditions , (sun light , Heat & rain) even when installed directly as a pool decking , needs low maintenance , you just need to give it some attention to keep it as beautiful as day one.</p>
                        <h4>1. Do Sweep Debris Immediately</h4>
                        <img class="mb-2 w-100" src="http://thewoodcourt.com/storage/app/public/uploads/ZoYMinuvWQUUD4ZSO0KhjwRnHSKaihAB1i3SVBII.png" alt="1">
                        ...
                        <img class="mb-2 w-100" src="http://thewoodcourt.com/storage/app/public/uploads/mdtMtQN1nUzQqKue53QTVW985Ex7h8l26pAlIfNp.png" alt="1">
                        <h4>5. Do Let Your Wood Dry Completely </h4>
                        <img class="mb-2 w-100" src="http://thewoodcourt.com/storage/app/public/uploads/5Q7ak86yCI3nFSB3jheeYxmSQtK3c6zL4zzNcsqa.png" alt="1">
                        ...
                        <img class="mb-2 w-100" src="http://thewoodcourt.com/storage/app/public/uploads/56SyFhfkqwJQI3NM8WjsFCpQrV4Ovx1DNKcNO8sC.png" alt="1">
                  ...
                  <div class="tab-pane fade" id="finishing-techniques" role="tabpanel">
                    ...
                    <h3>1.Site Finish:</h3>
                    <p>When you go for site- Finish wood floors, then you are purchasing wood floors which will be shipped to your home unfinished , to be Sanded, possibly stained and then sealed and finished with a top protective layer in your home. This process takes & a bit a long time, produces dust during sanding , bad smell during coating. in this type
                    </p>
                    <ul>
                    ...
                    <p>When you get site-finished floors you get seamless to however , with weather savings, graying from high temp , humidity, to low & vice versa , this option fade away , as wood is a living product , it expands and contracts leading to visible joints</p>
                    <h2>2. Pre-Finished:</h2>
                    <p>In the last 25 years, prefinished Floors started to grow, as harduratth Floors manufacturing become more technical in this Case, the Floor finishing is part of the manufacturer Job, & the product shipped to your home finished 2 ready to be installed ..
                    </p>
                    <ul>
                    ...
                    <h4>Durability :</h4>
                    <p> when the floor manufacturer Finished the floor, it uses special Finished lines, which create Perfect environment to apply powerful chemical scalier such as alumerian & tilenum oxides embedded in a uv-cured urethane Coat the perfect the result is harder than anything applied in site the finish lasts bager & Carries a better warranty for the homeowner.
                        <b>easier installation:</b>
                        Requires no sanding, no slaening , no sealing no top Coat as all are pre-done in our factory You Just need your Floors to be installed then you can walk on immediately!
                    ...
                    <p>it is the process in which the coat a changes from liquid state to solid state under ultraviolet rays instantly in a sealed <br><br>
                        <b> Finishing Live, no no dust will stick to planks, so it results with smooth Surface unlike site finish which it is very hard to prevent very fine dust from sticking to floors daring the long curing time and gran environment</b><br><br>
                        Sub. Floors preparation: <br>
                        For site- Finish , irregularity of subfloor is not a big problem as sending process is
            ...
            <div class="tab-pane fade" id="resources" role="tabpanel">
              <div class="tab-content">
                <div class="tab-pane fade show active" id="engineered-floors" role="tabpanel">
                  ...
                  <p>you can ask for a refinished engineered flooring in which coating are by the menutaclured in factory not by the installer in site
                      <br><br>
                      this operation is done using very high coating technology [uv] technology , as the protect are coated with polymers which changes from liquid slate to violet rays were the leaders & make it anti-scratch , more durable , and smoother as whrobe operation is done inside a(uv) coating live not exposed to there are no dust sticky to the sarlace and decreame smoother.
                      <br><br>
                      at least (2) sealing eates , and one layer of (anti-scratch) top coat are applied to engineered planks , in addition to staining layer (if needed) which is applied on wood before applying the bottom and top layers , so it is guaranteed that under bad wrage , the color not also to be removed Fig.3</p>
                  ...
                  <div class="accordion" id="accordionExample">
                          ...
                          <div id="collapse-1" class="collapse " aria-labelledby="heading-FAQ-1"
                              ...
                              <div class="card-body">
                                  <p>*They offer an elegant and timeless look that never goes out of style. <br>
                                      *They also enable a look of spaciousness and lend a warm and authentic feel
                                      wherever
                                      they’re installed. <br>
                                      *Wood flooring offers a variety of appearances; from grain patterns to
                                      colours,
                                      stains and designs. <br>
                                      *The floors are easy to clean as they do not accumulate a lot of dirt, dust
                                      and
                                      debris. <br>
                                      *Wood floors have long-term durability and can last for generations. <br>
                                      *They are a great long-term investment and can increase the value of your
                                      property.
                                      <br>
                                      *Properly installed wood floors increase and improve acoustics in the room;
                                      suitable
                          ...
                          <div id="collapse-2" class="collapse " aria-labelledby="heading-FAQ-2"
                              ...
                              <div class="card-body">
                                  <p>*Wood floors are relatively easy to clean and maintain and can live in
                                      harmony with
                                      pets. However, they are vulnerable to scratches — hence choosing a harder
                                      species of
                                      wood makes it possible to enjoy your gorgeous floor without stressing about
                                      your
                                      pets. <br>
                                      *A rustic or distressed finish is particularly a good option since it easily
                                      hides
                                      signs of everyday wear and tear. Alternatively, you may want to select wood
                                      flooring
                                      with a lighter colour and lower gloss level to help hide additional marks
                                      that may
                                      occur. <br>
                          ...
                          <div id="collapse-3" class="collapse " aria-labelledby="heading-FAQ-3"
                              ...
                              <div class="card-body">
                                  <p>*Wood is a natural material, each plank features unique details and
                                      ...
                                      * Most people love these slight variations for added character and charm
                                      that they
                                      offer. The higher grade of wood flooring tends to feature a more uniform
                                      colour and
                          ...
                          <div id="collapse-4" class="collapse " aria-labelledby="heading-FAQ-44"
                              ...
                              <div class="card-body">
                                  <p>*Engineered woods have a variable top layer thickness compared to solid wood.
                                      engineered floors can be refinished — and the and thickness of the top layer
                                      is the
                                      major factor contributing to this. here in the wood court we manufacture 9mm
                                      thick
                          ...
                          <div class="card-body">
                              <div id="collapse-5" class="collapse " aria-labelledby="heading-FAQ-4"
                                  ...
                                  <p>Yes, it’s possible. If you want to install your floor over ceramic tiles, a
                                      glued-down methodology or floating is the available methods choosing the
                                      suitable
                                      method is depending on the type of wood floors you want to install, either
                                      engineered wood or solid wood, also depends on the finish type, prefinished
                                      or site
                                      finish, dimension of needed blanks may be a factor, you can contact the wood
                                      court
                      ...
                      <div class="card-body">
                          <div id="collapse-6" class="collapse " aria-labelledby="heading-FAQ-5"
                              data-parent="#accordionExample">
                              <p>Wood is a natural product, high temperature and moisture level in the kitchen
                                  may
                                  cause it to contract and expand. In this case, engineered wood is your best
                                  option
                                  to avoid cupping and gapping. <br>
                                  Occasionally a kitchen may experience spills and stains, but if cleaned up
                                  promptly
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-7" class="collapse " aria-labelledby="heading-FAQ-6"
                                  data-parent="#accordionExample">
                                  <p>Gapping is fairly normal during the winter season due to change in humidity
                                      of the
                                      room which causes wood to dry out and shrink. To combat the issue, use a
                                      humidifier
                                      during winter months to keep your home within the required temperature — as
                                      long as
                                      humidity level is in between 35-50%. <br>
                                      Depending on your wood selection, certain species tend to contract and
                                      expand more
                                      than others.<br>
                                      Using an engineered wood floor will reduce the appearance of gapping as it
                                      is more
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-8" class="collapse " aria-labelledby="heading-FAQ-7"
                                  data-parent="#accordionExample">
                                  <p>In some instance, wood can be glued down over existing floors such as:
                                      laminate,
                                      vinyl, wood floors, and even some types of tile. <br>
                                      The existing floor has to be relatively smooth, free of major imperfections
                                      and
                                      fully adhered to the sub-floor. <br>
                                      It is important that the installer follows the manufacturers recommended.
                                  </p>
                              </div>
                          </div>
                      </div>
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-9" class="collapse " aria-labelledby="heading-FAQ-8"
                                  data-parent="#accordionExample">
                                  <p>No. The thicker and better quality engineered woods will last for years and
                                      years and
                                      can be refinished once or twice. <br>
                                      Also, the technology and factory applied, UV-cured urethane finishes with
                                      melamine
                                      that are used today by the wood court makes a really tough & durable finish
                                      and is
                                      ...
                                      dimensionally stable than solid hardwood flooring so they can be used in
                                      many
                                      situations where solid wood is not recommended. <br>
                                      click here to learn more about the deffirence between engineered and solid
                                      wood
                                      floors.</p>
                              </div>
                          </div>
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-10" class="collapse " aria-labelledby="heading-FAQ-9"
                                  data-parent="#accordionExample">
                                  <p>Today's wood floors do not require a paste wax to the finish and paste waxes
                                      should
                                      not be used. Most hardwood floors today have some type of urethane finish
                                      and will
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-11" class="collapse " aria-labelledby="heading-FAQ-10"
                                  ...
                                  <p>Unfinished flooring must be finished on site after installation takes place.
                                  </p>
                                  <p> Aluminum oxide cannot beused in the finish on site because the longer drying
                                      time
                                      causing the aluminum oxide particles to sink to the bottom of the finish.
                                  </p>
                                  <p>Site-finished floors usually are better at protecting against above floor
                                      moisture.
                                  </p>
                              </div>
                          </div>
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-12" class="collapse " aria-labelledby="heading-FAQ-11"
                                  data-parent="#accordionExample">
                                  <p>Engineered hardwood floors can be floated, but not solid hardwood floors, due
                                      to high
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-13" class="collapse " aria-labelledby="heading-FAQ-12"
                                  data-parent="#accordionExample">
                                  <p>Moisture can cause many different problems for a hardwood floor, such as
                                      cracking,
                                      cupping, and crowning</p>
                                  <p>. Over time, excessive moisture will destroy a wood floor, so it is suggested
                                      not to
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-14" class="collapse " aria-labelledby="heading-FAQ-13"
                                  data-parent="#accordionExample">
                                  There is water caught between the wood flooring and the subfloor if crowing or
                                  cupping
                                  occurs. <br>
                                  Crowning is when the center boards are higher than the outer boards. <br>
                                  Cupping is when the outer boards are higher than the center boards, also if any
                                  moisture
                                  marks found in any of your walls, sudden black stains on wood floor surface
                                  started to
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-15" class="collapse " aria-labelledby="heading-FAQ-14"
                                  data-parent="#accordionExample">
                                  <p>well, it depends, if you will install a prefinished wood floors, then the
                                      perfect
                                      time for installing is the high end, when every single technition is out of
                                      your
                                      home
                                      expect the painter, you may need a painter to fill gaps between the
                                      skirtting and
                                      the wall (if founded)
                                      but if you purchased site finish floors, you have to install it a bit
                                      earlier, but
                                      do not finish immediatly after installation, minimum 7-12 days are needed
                                      befor site
                                      finishing
                                      to let the wood floors reacts withe site conditions, wood moisture and
                                      temprature
                                      reach equilibrium state, also in case of glued down installation technique,
                                      it
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-16" class="collapse " aria-labelledby="heading-FAQ-15"
                                  ...
                                  <p>These can be purchased at many retail stores, and are designed not only to
                                      reduce or
                                      prevent scratching, but also to reduce or prevent movement of the furniture
                                      all
                                      together.</p>
                              </div>
                          </div>
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-17" class="collapse " aria-labelledby="heading-FAQ-16"
                                  ...
                                  <p>Part of the overall cost savings derived from installing laminate is in
                                      labor.</p>
                                  <p>Almost anyone can install a laminate floor and get professional results.</p>
                                  <p>Laminate flooring is an excellent choice for high traffic areas and where
                                      damage from
                                      pets is a concern.</p>
                                  <p>It is also an excellent choice for many commercialapplications where scratch
                                      damage
                                      is a major concern.</p>
                                  <p>Versatility is another factor to consider when choosing laminate.</p>
                                  <p>If you aren’t trying to get the look of wood, laminate offers stone, metal
                                      and
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-18" class="collapse " aria-labelledby="heading-FAQ-17"
                                  ...
                                  <p> Discerning clients will demand real hardwood when shopping for a new home
                                      and if
                                      resale value is a concern, hardwood flooring will give you the highest
                                      return on
                                      investment.</p>
                              </div>
                          </div>
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-19" class="collapse " aria-labelledby="heading-FAQ-18"
                                  data-parent="#accordionExample">
                                  <p>While there are many fine, durable, beautiful woods, none hold a candle to
                                      teak.</p>
                                  ...
                                  <p>Because of the high oil content, teak is essentially waterproof and does not
                                      crack or
                                      warp due to damp climates.</p>
                                  <p>Teak is resistant to termites and other wood pests, which makes it ideal for
                                      projects
                                      that are usually vulnerable to termite infestation</p>
                                  <p>Teak also gets to brag that it doesn’t crack or turn colors when exposed to
                                      metals,
                                      which makes it great for building long-lasting furniture.</p>
                                  <p>Teak wood has been used to build boat decks — rather, battleships — for
                                      centuries
                                      because of its water resistance and strength.</p>
                                  <p>Today, teak is used anywhere that any other wood is, and is popular for
                                      creating
                                      bath, spa, pergolas and pool furniture because it allows the natural look of
                                      wood
                                      without the weathered appearance or swelling that other woods take on when
                                      exposed
                          ...
                          <div class="card-body">
                              <div id="collapse-20" class="collapse " aria-labelledby="heading-FAQ-19"
                                  ...
                                  <p>You have a lot of different traditional and modern countertop options:
                                      ...
                                      Wood/butcher block
                                      Stainless steel
                                      stainless steel countertops work well in modern spaces, but this doesn’t
                                      mean other
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-21" class="collapse " aria-labelledby="heading-FAQ-20"
                                  data-parent="#faq2">
                                  <p>A chef’s kitchen is designed for those who often prepare large meals and need
                                      a
                                      kitchen design that supports heavy-duty cooking tasks. Essentially,a chef’s
                                      kitchen
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-22" class="collapse " aria-labelledby="heading-FAQ-21"
                                  data-parent="#faq2">
                                  <p>The kitchen work triangle refers to the area from the refrigerator to the
                                      cooking
                                      range to the sink—the three points are the three corners of the triangle.
                                  </p>
                                  <p> There should be easy movement between the three places—and there shouldn’t
                                      be too
                                      much distance between them. Basically, the work triangle creates a more
                                      efficient
                                      work space.</p>
                              </div>
                          </div>
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-23" class="collapse " aria-labelledby="heading-FAQ-22"
                                  data-parent="#faq2">
                                  <p>An appliance garage is a cabinet that is typically installed underneath wall
                                      cabinets
                                      or tucked in the corner of a cabinet in a space that would otherwise be
                                      unused.</p>
                                  <p>They are used to keep smaller appliances and other items off the countertops,
                                      freeing
                                      up more workspace.</p>
                                  <p>Appliance garages can have shutter or cabinetry door fronts and the doors can
                                      often
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-24" class="collapse " aria-labelledby="heading-FAQ-23"
                                  data-parent="#faq2">
                                  <p>Integrated kitchen design hides appliances or blends them in naturally with
                                      the rest
                                      of the room—it creates a clean, uncluttered look and can help modernize a
                                      space</p>
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-25" class="collapse " aria-labelledby="heading-FAQ-24"
                                  data-parent="#faq2">
                                  <p>The sink should be within easy reach of the refrigerator and cooktop/range
                                      since you
                                      use them often. It should also be near the trash.</p>
                                  <p>. Keep in mind that there should be about 50-70 cm of counter space on either
                                      side.
                                  </p>
                                  <p>. The layout of your kitchen will affect whether it should be placed against
                                      a wall
                                      or in the island</p>
                              </div>
                          </div>
                          ...
                          <div class="card-body">
                              <div id="collapse-26" class="collapse " aria-labelledby="heading-FAQ-25"
                                  ...
                                  <p><b>There are several tile materials that work well in kitchens,
                                          including:</b><br>Stain-resistant porcelain <br>Vinyl <br>granite
                                      <br>Wood</p>
                              </div>
                          </div>
                      </div>
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-27" class="collapse " aria-labelledby="heading-FAQ-26"
                                  data-parent="#faq2">
                                  <p> <b>When you’re trying to narrow down your choices between a few different
                                          kitchen
                                          designers, ask each company questions like:</b> <br>
                                      How long have you been in business?<br>Can you provide references I can
                                      contact?<br>What are past projects you’ve done? Can I see your portfolio?
                                      <br> <br>
                                      <b> Once you’ve chosen the company, ask questions such as:</b> <br>
                                      Is an island a good option for my kitchen?<br>If I want to increase the
                                      resale value
                                      of my home, what should I add to the kitchen? <br> What kind of cabinetry
                                      would work
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-28" class="collapse " aria-labelledby="heading-FAQ-27"
                                  data-parent="#faq2">
                                  A kitchen backsplash is a pattern of tiles installed on the wall, usually behind
                                  the
                                  cooking range and/or sink. <br>
                                  A backsplash provides protection from water damage and grease hazards, but it
                                  can also
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-29" class="collapse " aria-labelledby="heading-FAQ-28"
                                  data-parent="#faq2">
                                  <p>You can—and should—talk to your kitchen design team, but browsing through
                                      magazines
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-30" class="collapse " aria-labelledby="heading-FAQ-29"
                                  data-parent="#faq2">
                                  <p>There are plenty of different kitchen styles to choose from. The main ones
                                      are
                                      ...
                                      Keep in mind that the wood court can customize your kitchen design to fit
                                      your
                                      personal tastes. You don’t have to stick with one style. <br>
                                      However you want your kitchen to look, we can make it happen. cotact us to
                                      learn
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-31" class="collapse " aria-labelledby="heading-FAQ-30"
                                  data-parent="#faq2">
                                  Depending on how involved the project is, also depends on your kitchen material,
                                  it
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-32" class="collapse " aria-labelledby="heading-FAQ-31"
                                  data-parent="#faq2">
                                  <p>Melamine is particleboard laminated with a thermally fused paper/resin
                                      coating to
                                      provide a durable hard surface.<br> Great for making cabinet carcases
                                      because it
                                      wipes clean easily. Use it, as well, for shop fixtures or to make an
                                      economical
                                      router-table top.<br> Melamine is resistant to scratches, chemicals and
                                      staining.
                                  </p>
                              </div>
                          </div>
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-33" class="collapse " aria-labelledby="heading-FAQ-32"
                                  data-parent="#faq2">
                                  <p>Melamine is a popular plastic material used in modern home cabinetry. <br> It
                                      is very
                                      durable and has a wide variety of hue and pattern possibilities. ... <br>
                                      Engineered
                                      products using Melamine are less expensive and as reliable as wood. <br> HPL
                                      or TFL
                                      is Melamine fused with MDF or Particle Board,which are made from wood chips.
                                  </p>
                              </div>
                          </div>
                      </div>
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-34" class="collapse " aria-labelledby="heading-FAQ-33"
                                  data-parent="#faq2">
                                  <p>Pine. Pine is another popular wood choice by homeowners who are designing
                                      their
                                      kitchen cabinets. <br> This wood is very cost effective and is generally the
                                      least
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-35" class="collapse " aria-labelledby="heading-FAQ-34"
                                  data-parent="#faq2">
                                  <p>In most cases, engineered wood products are used instead because they're just
                                      as
                                      reliable and a lot cheaper. <br> The most widely used kinds for cabinet
                                      boxes are
                                      constructed from medium density fiberboard (MDF), plywood, particleboard
                                      with
                                      melamine</p>
                              </div>
                          </div>
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-36" class="collapse " aria-labelledby="heading-FAQ-35"
                                  data-parent="#faq2">
                                  <p>Laminate cabinets are generally significantly less expensive than wood
                                      cabinets,
                                      making them an attractive option for those looking for a contemporary style
                                      and
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-37" class="collapse " aria-labelledby="heading-FAQ-36"
                                  data-parent="#faq2">
                                  <p>Value – furniture made from solid wood tends to have more value than those
                                      made from
                                      engineered wood, though in some cases MDF furniture can be quite pricey.
                                      <br> For
                                      homeowners looking to get a better price for their home, adding elements of
                                      solid
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-38" class="collapse " aria-labelledby="heading-FAQ-37"
                                  data-parent="#faq2">
                                  <p>White is your best friend in a small kitchen. It reflects light, enhancing
                                      the sense
                                      of space and making the walls recede. <br> When you include white on
                                      cabinetry,
                                      countertops, walls, and the ceiling, you create a seamless space without
                                      edges or
                                      boundaries</p>
                              </div>
                          </div>
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div id="collapse-39" class="collapse " aria-labelledby="heading-FAQ-38"
                                  data-parent="#faq2">
                                  <p>High-pressure laminates are a great choice for kitchen cabinets, but can be
                                      on the
                                      pricy side. ... <br> Laminate cabinets are easier to clean than wood, they
                                      offer
                                      more durability over time and tend to conceal fewer scratches than solid
                                      wood
                          ...
                          <div class="card-header" id="heading-FAQ-39">
                              <h2 class="mb-0">
                                  <button class="btn btn-link" type="button" data-toggle="collapse"
                                      ...
                                      what are the deffirent types of laminate you use in the wood court for
                                      kitchens?
                                  </button>
                              </h2>
                          </div>
                          ...
                          <div class="card-body">
                              <div id="collapse-40" class="collapse " aria-labelledby="heading-FAQ-39"
                                  ...
                                  <p>Anti Fingerprint Laminate.Anti fingerprint laminates are resistant to
                                      fingerprints,
                                      dirt, heat and scratches. ... <br> Matte Finish Laminates. mutt plus boards
                                      Gloss
                                      Finish Laminates.<br> mirror gloss look like Textured Laminate.either wood
                                      or other
    ...
    <script type="text/javascript">
        ...
        $('.sub-category-filter').click(function(e){
