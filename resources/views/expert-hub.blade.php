            ...
            <div class="col-lg-9 col-12">
                <div class="tab-pane fade show active" id="wood-care" role="tabpanel">
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="floor-care" role="tabpanel">
                            <h2>How To Take Care Of Your Indoor Flooring?</h2>
                            <img class="w-100 h-50 my-3" src="{{url('public/images/categories/wood-flooring/engineered-floors/1.jpg')}}" alt="wood-care">
                            ...
                            <ul class="ml-0">
                                <li>Don't Spill Water to Clean <br>
                                    Never ever use a wet mop to clean your wood floor either natural wood or
                                    HDF (High density fiber).
                                </li>
                                <li>Use a Damp Mop <br>
                                    Use damp mop to remove dust first , to make your floor dust free.
                                </li>
                                <li>Don't Use Furniture Sprays <br>
                                    Then it is recommended to use oil based cleaners specially made for your wood floors. Once a month
                                </li>
                                <li>
                                    Use Oil-Based Cleaners <br>
                                    DO NOT use furniture cleaners to clean. Your wood floors will be slippery.
                                </li>
                                <li>Don't Use Chemicals, Acids, or Alcohols<br>
                                    Do Not use alcohol, acids ,or chemicals to clean your wood floors. It can damage your wood flooring.
                                </li>
                                <li>Use Microfiber Towel in Direction of the Texture <br>
                                    Always wipe parallel to grams direction, as that will clean the grooves
                                    much better. Use a microfiber towel to clean your wood floors. It will remove
                                    stains, clean your floor & make it shiny.
                                </li>
                                <li>Remove Spills Immediately <br>
                                    Remove spills immediately, long exposure to liquids will lead to damage.
                                </li>
                                <li>Don't Forget to Use Coasters <br> 
                                    Use soft coasters under your furniture to prevent scratches.</li>
                                <li>Keep Your Pets' Nails Trimmed <br>
                                    Regulary clip your pets’ nails to avoid deep scratches
                                </li>
                                ...
                                <li>Don't Leave Electronics Powered On <br>
                                    Don't put any electronics directly on the wood floor ,the heat generated from these
                                  devices will affect your floors negatively in the long run.
                                </li>
                                ...
                                <li>Do Ventilate Your Home <br>
                                     Ventilate your home, good ventilation will make your wood floors healthy & live longer.</li>
                                <li>Do Keep Your Humidity In-check <br>
                                     Best atmosphere conditions to make your wood floors healthy is 30% - 50% relative
                        ...
                        <div class="tab-pane fade show" id="kitchen-care" role="tabpanel">
                            <h2>How to Take Care of Your Kitchen Counters and Cabinets?</h2>
                            <img class="w-100 h-50 my-3" src="{{url('public/images/categories/cabinets/kitchens/1.jpg')}}" alt="kitchens">
                            <ul>
                                <li>Do Remove Food Spills Immediately <br>
                                    Clean all food spills from wood surfaces immediately & thoroughly, most foods can
                                    damage wood finishes eventually.
                                </li>
                                <li>Do Prevent Spilling Acidic Juices <br>
                                    Prevent spilling of acidic food or juices as much as you can on wood surfaces,
                                    such as orange juice.
                                </li>
                                <li>Do Use Coasters Under Drinks <br>
                                    Tea, coffee & other many drinks are great, but will leave a bad-look stain on
                                    wood surfaces if they’re not cleaned immediately.
                                </li>
                                <li>Don’t Clean With a Sponge <br>
                                    When cleaning a wood surface, use a microfiber towel, do not use dish sponge or
                                    washing as it may damage wood surfaces.
                                </li>
                                <li>Do Wipe With Water and Soap <br>
                                    Clean your kitchen cabinets and surface wring clean water & mild soap with a
                                    clean ,lint-free rag
                                </li>
                                <li>Don’t Use Too Much Water <br>
                                    Use water sparingly and a towel to dry any excess , when water sits , it can
                                    penetrate the finish and raise the wood grains up leading to a rough uncleanable
                                    surface in future
                                </li>
                                <li>Do Wipe Parallel to The Grain <br>
                                    Wipe Parallel to the wood grains direction , remove dust with dry micor-fiber
                                    towel , it is your first step to clean your kitchen
                                </li>
                                <li>Don’t Use Wax to Polish <br>
                                    Always use polish cream monthly to shine your kitchen instead of waxing , wax
                                    makes a shiny look but attracts dust.
                                </li>
                                <li>Don’t Overuse Silicon Cleaners <br>
                                    Be cautious of overuse of surface cleaners & sprays as they may contain silicon,
                                    which will make layers & layers order wood surface & results with a pale look
                                    with time
                                </li>
                                <li>Do Use Food-grade Mineral Oil <br>
                                    When it comes to wooden counter-top , it is very important to use a “Food grade
                                    mineral Oil”.
                                </li>
                                <li>Do Use a Ventilating Fan <br>
                                    Use a ventilating fan when cooking , it remove the majority of airborne smoke &
                                    grease which other wish may be absorbed by wood leading to bad smell & yellowish
                                    stains
                                </li>
                            </ul>
                        </div>
                        <div class="tab-pane fade show" id="outdoor-care" role="tabpanel">
                            <h2>How to Take Care of wooden pergolas & Outdoor Flooring?</h2>
                            <img class="w-100 h-50 my-3" src="{{url('public/images/categories/outdoor/pergolas/1.jpg')}}" alt="outdoor">
                            ...
                            <ul>
                                <li>Do Sweep Debris Immediately <br>
                                    Pick up large debris like paper and fallen tree leaves at once.
                                </li>
                                <li>
                                    Do Use a Vacuum Cleaner for Sand <br>
                                    Use a vacuum machine to remove dust from the in between grooves, it is much
                                    easier than whisking.
                                </li>
                                <li>
                                    Do Use Ammonia to Remove Dirt <br>
                                    Use a mixture of ammonia & warm water with ratio 1:4 to help you remove all the
                                    stuck dirt & debris , by wiping the wood with the mixture using a sponge mop.
                                </li>
                                <li>Do Wipe Parallel to the Grain</li>
                                <li>Do Let Your Wood Dry Completely <br>
                                    let your wood either floors or pergola to dry completely , at leave 3-5 hours
                                    temperature +15 ℃
                                </li>
                                <li>Do Use Oil-based Cleaners <br>
                                    Use a floor cleaner specially made for your hardwood, It will always be on
                                    oil-based cleaner, not water or aqua-based.
                                </li>
                                <li>Do Keep Wood Well-Oiled <br> 
                                    Teak wood has natural oil that keeps mold down, this natural oil also works as an
                                    insect repellent & prevents wood from cracking when exposed to high temperature.</li>
                                <li>Don’t Expose to Too Much Sunlight <br>
                                    When wood is exposed to direct sunlight, this oil gradually by time will
                                ...
                                <li>Do Follow the Grains and Rub Well <br>
                                    When applying teak oil, follow the wood grains using a clean rag, and rub in
                                    well.
                                </li>
                                <li>Don't Use Too Much Oil <br>
                                    Do not apply a heavy layer of oil, 70-100 grams is more than enough for each
                                    square meter.
                                </li>
                                <li>Do Wait For Oil to Dry To Avoid Spots <br> 
                                    After one hour use a clean new rag to remove excess oil and let it completely dry
                                    before placing your furniture back to avoid spots.
                                </li>
                                <li>Do Wipe Spills Immediately <br> 
                                    Always remove any spills immediately, to avoid spots. If you have spots, just
                                    apply a small amount of ammonia and it will disappear instantly.
                                </li>
                                <li>Don’t Use Insect Repellants and Anti-rot Agents <br> 
                                    You don't have to use any insect repellant for teak wood, as teak wood grains are
                                ...
                                <li>Don't Forget Your Protective Gear <br>
                                    Always wear rubber gloves, eye protection, and a mask while using any chemical
                                    materials.
                                 </li>
                            </ul>
                        </div>
                ...
                <div class="tab-pane fade show" id="toturial" role="tabpanel">
                    <div class="tab-content">
                        <div class="tab-pane fade" id="installation-methodology" role="tabpanel">
                            ...
                            <img class="mb-2 w-100" src="{{url('public')}}/images/expert-hub/articles/5.png"
                                alt="1">
                            ...
                            <img class="mb-2 w-100" src="{{url('public')}}/images/expert-hub/articles/6.png"
                                alt="1">
