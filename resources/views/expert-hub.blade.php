        ...
        <div class="row">
            <div class="col-lg-4 col-12 ">
                <div class="products-sidebar mb-5" id="expert-hub-sidebar">
                    <ul class="filter-items nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        <li>
                            <a class="nav-item nav-link main-category-filter" data-toggle="tab" href="#nav-articles">Articles</a>
                            <ul>
            ...
            <div class="col-lg-8">
                <div class="tab-content" id="nav-tabContent">
                  <div class="tab-pane fade" id="nav-toturial">
                    <div class="tab-pane fade" id="nav-woodcare">
                    ...
                    <div class="tab-pane fade" id="nav-finishing-techniques">
