...
<body>
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/ar_AR/sdk.js#xfbml=1&version=v10.0" nonce="D1CqeXtD"></script>
        ...
        <div class="row">
          <div class="col-lg-8 col-12">
            ...
            <div class="event-content">
              {!! $TheArticle->content !!}
              <div class="fb-comments" data-href="https://thewoodcourt.com" data-width="100%" data-numposts="5000000000000000000000000000000"></div>
            </div>
          </div>
